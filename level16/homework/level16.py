...
boolean = [False, True, 10 > 5, 10 == 10]
print(boolean.count(True))


# 4) Count occurrences of a sublist [3, 4] in a nested list. 
numbers = [1, 5, [3,4], 13, 15, [3,4], 5]
...
weekdays = ["Monday", "Tuesday", "Wedneday", "Tursday", "Friday", "Saturday"]
print(len(weekdays))
